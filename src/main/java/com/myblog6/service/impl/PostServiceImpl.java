package com.myblog6.service.impl;

import com.myblog6.entity.Post;
import com.myblog6.exception.ResourceNotFound;
import com.myblog6.payload.PostDto;
import com.myblog6.payload.PostResponse;
import com.myblog6.repository.PostRepository;
import com.myblog6.service.PostService;
...
@Autowired
    ...
    @Override
    public List<PostDto> getPosts(int pageNo, int pageSize, int sortBy) {
        return null;
    }
